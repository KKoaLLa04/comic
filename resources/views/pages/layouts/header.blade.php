    ...
    <nav class="navbar navbar-expand-lg navbar-dark header__navbar p-md-0">
        <div class="container">
            <a class="navbar-brand" href="{{route('index')}}">
                <img src="{{asset('client/images/logo_text.png')}}" alt="Logo Suu Truyen" srcset="" class="img-fluid"
                    style="width: 200px;">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <ul class="dropdown-menu dropdown-menu-custom">
                            @if(!empty($category))
                                @foreach($category as $key => $cate)
                                    <li><a class="dropdown-item" href="{{route('category', ['slug' => $cate->slug])}}">{{$cate->title}}</a>
                                    </li>
                                @endforeach 
                            @endif
                        </ul>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-custom">
                            <li><a class="dropdown-item" href="{{route('book')}}">tất cả sách</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <form autocomplete="off" class="d-flex header__form-search" action="{{route('search')}}" method="POST">
                    @csrf
                    <input class="form-control search-story" type="text" id="keywords" placeholder="Tìm kiếm" name="keyword"
                        value="" style="position: relative">

                    <div id="search_ajax" style="position: absolute; bottom:0px"></div>
